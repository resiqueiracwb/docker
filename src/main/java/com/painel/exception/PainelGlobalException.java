 ...
 */
@ControllerAdvice
public class PainelGlobalException extends ResponseEntityExceptionHandler {
    @ExceptionHandler({ CertificacaoNotFoundException.class, ObraExternaNotFoundException.class, PredioNotFoundException.class, DocumentNotFoundException.class, DocumentNotFoundPrumaException.class , AgendamentoNotFoundException.class, VistoriaNotFoundException.class, ProjetoNotFoundException.class})
